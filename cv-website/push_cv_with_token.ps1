...
& "C:\Program Files\Git\cmd\git.exe" commit -m "Initial CV website commit"
& "C:\Program Files\Git\cmd\git.exe" branch -M main

$clientId = '178c6fc778ccc68e1d6a'
$deviceCode = '4406f639a69b3c78ba2fa04eb42d209e8a12154a'
$token = $null
...
& "C:\Program Files\Git\cmd\git.exe" remote add origin "https://oauth2:$token@github.com/hoanglongkudo8386-byte/cvxinvc2003.git" 2>$null
