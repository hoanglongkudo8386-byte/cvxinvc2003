& "C:\Program Files\Git\cmd\git.exe" add css/pages.css
& "C:\Program Files\Git\cmd\git.exe" commit -m "UI/UX Expert fixes: improve contrast, typography, and visual hierarchy"

$clientId = '178c6fc778ccc68e1d6a'
$deviceCode = '88e238a817c5878ef5447830dcb5bf3d0e04d571'
$token = $null
